...
namespace Facebook_Tool_Request.Helpers
{
    internal class SetupFolder
    {
        ...
        public static List<string> GetListCountryShopLikePrx()
        {
        ...
        {
            bool fa2 = !CommonSQL.CheckColumnIsExistInTable("accounts", "fa2");
            if (fa2)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "fa2", 1);
            }
            bool useragent = !CommonSQL.CheckColumnIsExistInTable("accounts", "useragent");
            if (useragent)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "useragent", 1);
            }
            bool proxy = !CommonSQL.CheckColumnIsExistInTable("accounts", "proxy");
            if (proxy)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "proxy", 1);
            }
            bool dateCreateAcc = !CommonSQL.CheckColumnIsExistInTable("accounts", "dateCreateAcc");
            if (dateCreateAcc)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "dateCreateAcc", 1);
            }
            bool avatar = !CommonSQL.CheckColumnIsExistInTable("accounts", "avatar");
            if (avatar)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "avatar", 1);
            }
            bool profile = !CommonSQL.CheckColumnIsExistInTable("accounts", "profile");
            if (profile)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "profile", 1);
            }
            bool ghiChu = !CommonSQL.CheckColumnIsExistInTable("accounts", "ghiChu");
            if (ghiChu)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "ghiChu", 1);
            }
            bool follow = !CommonSQL.CheckColumnIsExistInTable("accounts", "follow");
            if (follow)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "follow", 1);
            }
            bool interactEnd = !CommonSQL.CheckColumnIsExistInTable("accounts", "interactEnd");
            if (interactEnd)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "interactEnd", 1);
            }
            bool dateImport = !CommonSQL.CheckColumnIsExistInTable("accounts", "dateImport");
            if (dateImport)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "dateImport", 1);
            }
            bool pass_old = !CommonSQL.CheckColumnIsExistInTable("accounts", "pass_old");
            if (pass_old)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "pass_old", 1);
            }
            bool cookie1 = !CommonSQL.CheckColumnIsExistInTable("accounts", "cookie1");
            if (cookie1)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "cookie1", 1);
                Connector.Instance.ExecuteNonQuery("UPDATE accounts SET cookie1=cookie");
            }
            bool active = !CommonSQL.CheckColumnIsExistInTable("accounts", "active");
            if (active)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "active", 0);
                Connector.Instance.ExecuteNonQuery("UPDATE accounts SET active=1");
            }
            bool dateDelete = !CommonSQL.CheckColumnIsExistInTable("accounts", "dateDelete");
            if (dateDelete)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "dateDelete", 1);
            }
            bool active1 = !CommonSQL.CheckColumnIsExistInTable("files", "active");
            if (active1)
            {
                CommonSQL.AddColumnsIntoTable("files", "active", 0);
                Connector.Instance.ExecuteNonQuery("UPDATE files SET active=1");
            }
            bool status282 = !CommonSQL.CheckColumnIsExistInTable("accounts", "status282");
            if (status282)
            {
                CommonSQL.AddColumnsIntoTable("accounts", "status282", 1);
            }
        }
        ...
        private static void ConfigChange()
        {
            ...
            Common.CreateFolder("log\\invite_pages");
            Common.CreateFile("log\\invite_pages\\success.txt");
            Common.CreateFile("log\\invite_pages\\error.txt");
            Common.CreateFolder("log\\spam");
            Common.CreateFile("log\\spam\\success.txt");
            Common.CreateFile("log\\spam\\error.txt");
            Common.CreateFolder("log\\create_pages");
            Common.CreateFile("log\\create_pages\\success.txt");
            Common.CreateFile("log\\create_pages\\error.txt");
            Common.CreateFolder("log\\seeding_pages");
            Common.CreateFile("log\\seeding_pages\\success.txt");
            Common.CreateFile("log\\seeding_pages\\error.txt");
            Common.CreateFolder("log\\ActivityClone");
            Common.CreateFolder("log\\logs");
            Common.CreateFolder("log\\logs\\reactions");
            Common.CreateFolder("log\\logs\\comments");
            Common.CreateFolder("log\\logs\\reviews");
            Common.CreateFolder("log\\logs\\follows");
            Common.CreateFolder("log\\logs\\likepage");
            Common.CreateFolder("log\\dataUid");
            Common.CreateFolder("log\\dataUid\\uid");
            Common.CreateFolder("log\\dataUid\\full");
            Common.CreateFolder("log_capture");
            Common.CreateFolder("log_capture\\log_captcha");
        }

        public static List<string> getListIdCategoriesPage()
        {
            return new List<string>
            {
                "181475575221097",
        ...
        public static List<string> GetListCountryTinsoft()
        {
            return new List<string>
            {
               "0|Random","1|Ha Noi","2|Phu Tho","3|Ho Chi Minh","4|Dak Lak","5|Hai Duong","6|Binh Dinh","7|Nghe An","8|Nam Dinh","10|Thai Binh","11|Ha Tinh","14|Bac Ninh","12|Gia Lai","13|Yen Bai","15|Ha Nam","16|Tra Vinh","17|Son La","18|Khanh Hoa","19|Dong Nai","20|Ba Ria Vung Tau","23|Hoa Binh","21|Lao Cai","22|Tuyen Quang","24|Hai Phong","25|Ha Giang","26|Quang Ninh"
            };
        }

        public static List<string> GetListSiteCaptcha()
        {
            return new List<string>
            {
                "omocaptcha|omocaptcha.com",
                "nopecha|NOPECHA",
            };
        }
        public static List<string> GetListSiteImage()
        {
            return new List<string>
            {
                //"unrealperson|unrealperson.com",
                "thispersondoesnotexist|thispersondoesnotexist.com"
            };
        }
        public static List<string> GetListGetToken()
        {
            return new List<string>
            {
                //"unrealperson|unrealperson.com",
